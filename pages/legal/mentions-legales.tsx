        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8">
            ...
            <section className="bg-gray-900 rounded-2xl p-8">
              ...
              <p className="text-gray-300 mb-4">
                L'ensemble du contenu du site Grim (logo, textes, graphismes, images, vidéos, etc.) est protégé par le droit d'auteur. Toute reproduction ou représentation, totale ou partielle, du site ou de l'un des éléments qui le composent, sans l'autorisation expresse de Grim, est interdite et constituerait une contrefaçon sanctionnée par le Code de la propriété intellectuelle.
              </p>
              <p className="text-gray-300">
            ...
            <section className="bg-gray-900 rounded-2xl p-8">
              ...
              <p className="text-gray-300">
                Le site Grim utilise des cookies pour améliorer l'expérience utilisateur. Pour en savoir plus sur l'utilisation des cookies, consultez notre Politique de Cookies, accessible depuis le pied de page du site.
              </p>
            </section>
            ...
            <section className="bg-gray-900 rounded-2xl p-8">
              ...
              <p className="text-gray-300">
                Grim s'efforce d'assurer l'exactitude et la mise à jour des informations diffusées sur son site. Toutefois, Grim ne peut garantir l'exactitude, la précision ou l'exhaustivité des informations mises à disposition sur le site. En conséquence, Grim décline toute responsabilité pour toute imprécision, inexactitude ou omission portant sur des informations disponibles sur le site.
              </p>
            </section>
